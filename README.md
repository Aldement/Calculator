...
## Тестироване программы

Эта программа имеет 6 тестов, сложение, вычитание, умножение и деление, а так же на наличие неизвестной операции и деление на ноль.

Что бы запустиить тест, нужно сначала убедиться что установлен pytest (pip install pytest), и потом в терминале ввести pytest.
